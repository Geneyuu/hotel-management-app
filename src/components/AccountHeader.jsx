...
const AccountHeader = () => {
    return (
        <div className="hidden md:flex w-full bg-[#18212F] justify-end items-center px-8 py-4 border-b border-gray-300/10">
            <div className="flex items-center gap-2">
                ...
                />
                <span className="text-xs text-gray-300 mr-4">Eugene Escario</span>
